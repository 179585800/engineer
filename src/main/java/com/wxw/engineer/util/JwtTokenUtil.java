...
public class JwtTokenUtil
{
     ...
     * @return
     */
    public static String createJWT(Map<String,Object> map, Audience audience) {
        try {
            // 使用HS256加密算法对称算法
...
//            //userId是重要信息，进行加密下
//            String encryId = CryptoUtils.encodeBASE64(userId);
            ...
            JwtBuilder builder = Jwts.builder().setHeaderParam("typ", "JWT")
                    ...
                    .setSubject((String)map.get("userName"))           // 代表这个JWT的主体，即它的所有人
    ...
    public static String getUserId(String token, String base64Security){
        ...
        return CryptoUtils.decodeBASE64(userId);
    }
